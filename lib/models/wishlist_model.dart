class Wishlist {
  ...
  int get purchasedItems => items.where((item) => item.status == ItemStatus.purchased).length;
  int get reservedItems => items.where((item) => item.status == ItemStatus.reserved).length;
  int get availableItems => items.where((item) => item.status == ItemStatus.desired).length;
