...
import 'package:wish_listy/features/reminders/data/repository/smart_reminder_repository.dart';
import 'package:wish_listy/features/auth/data/models/user_model.dart';
import 'package:wish_listy/features/events/data/models/event_model.dart';
import 'package:wish_listy/core/constants/mock_data.dart';
...
class _SmartRemindersScreenState extends State<SmartRemindersScreen>
  ...
  void _loadSmartReminders() async {
    ...
    final reminders = smartReminderRepository.generateSmartReminders(
      events,
      wishes,
      userProfile,
    );
