...
/// Custom widget for displaying friend request accepted notifications
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            // Leading: Avatar with checkmark badge (clickable)
            GestureDetector(
              onTap: onProfileTap,
              child: Stack(
                ...
                children: [
                  ...
                  // Green checkmark badge on bottom-right corner
                  Positioned(
                    right: -2,
                    bottom: -2,
                    child: Container(
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  // RichText: "{friendName} accepted your friend request"
                  RichText(
                    text: TextSpan(
                      style: AppStyles.bodyMedium.copyWith(
            ...
            // Trailing: Optional subtle check icon
