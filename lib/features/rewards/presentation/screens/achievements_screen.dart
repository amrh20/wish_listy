...
class _AchievementsScreenState extends State<AchievementsScreen>
  ...
  void _loadAchievements() async {
    ...
    setState(() {
      _achievements = _rewardsRepository.allAchievements;
      _isLoading = false;
    });
  }
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          // Progress indicator
          if (_rewardsRepository.currentUserRewards != null)
            Container(
              ...
              child: Text(
                '${_rewardsRepository.currentUserRewards!.unlockedAchievements.length}/${_achievements.length}',
