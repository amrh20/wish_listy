...
* **Content:** Wishlists, items, event details, and interests.
* **Social:** Friend lists and interactions (reservations, invites).

**3. How We Use Data**
* To create and manage your wishlists and events.
* To notify you about friend requests, gift reservations, and event updates.
* To suggest gifts based on your selected interests.

**4. Data Sharing**
We do not sell your personal data. Your wishlists are shared only with friends you approve (or public if you choose).

**5. Account Deletion**
You can request account deletion at any time from the app settings.
""";
...
* **المحتوى:** قوائم الأمنيات، تفاصيل الهدايا، والمناسبات.
* **البيانات الاجتماعية:** قائمة الأصدقاء والتفاعلات (الحجوزات والدعوات).

**3. كيف نستخدم بياناتك**
* لإنشاء وإدارة قوائمك ومناسباتك.
* لإرسال إشعارات حول طلبات الصداقة وحجز الهدايا.
* لاقتراح هدايا بناءً على اهتماماتك.

**4. مشاركة البيانات**
نحن لا نبيع بياناتك. قوائمك تتم مشاركتها فقط مع الأصدقاء الذين توافق عليهم.

**5. حذف الحساب**
يمكنك طلب حذف حسابك وبياناتك نهائياً في أي وقت من إعدادات التطبيق.
""";
...
**4. الملكية الفكرية**
تصميم وكود التطبيق مملوك لنا. المحتوى الخاص بك مملوك لك.
""";
}
